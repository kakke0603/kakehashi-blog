  ...
  if (random == 1) {
    return (
      <div>
        ...
        <img width="1" height="1" src="https://www11.a8.net/0.gif?a8mat=3Z0CMV+2Z6SY+5GDG+ZTFR5" alt="" />
      </div>
    );
  } else if (random == 2) {
    return (
    ...
    return (
      <div>
        ...
        <img width="1" height="1" src="https://www16.a8.net/0.gif?a8mat=3Z0E76+EI56B6+2BZM+4ATK5D" alt="" />
      </div>
    );
  } else if (random == 4) {
    <div>
      ...
      <img width="1" height="1" src="https://www14.a8.net/0.gif?a8mat=3Z0E76+EHJQPE+4V0U+ZQV5T" alt="" />
    </div>;
  } else if (random == 5) {
    <div>
      {/* コインランドリー */}
      ...
      <img width="1" height="1" src="https://www11.a8.net/0.gif?a8mat=3Z0E76+E39C6Q+4RZ4+NVHCX" alt="" />
    </div>;
  } else if (random == 6) {
    <div>
      ...
      <img width="1" height="1" src="https://www19.a8.net/0.gif?a8mat=3Z0E76+E2NWKY+4ZUQ+HW2Q9" alt="" />
    </div>;
  } else if (random == 7) {
    <div>
      ...
      <img width="1" height="1" src="https://www17.a8.net/0.gif?a8mat=3Z0CMV+1VVFQQ+5GDG+NVHCX" alt="" />
    </div>;
  } else if (random == 8) {
    <div>
      ...
      <img width="1" height="1" src="https://www12.a8.net/0.gif?a8mat=3Z0CMV+1U34XE+5GDG+601S1" alt="" />
    </div>;
  } else {
    <div>
      ...
      <img width="1" height="1" src="https://www12.a8.net/0.gif?a8mat=3Z0CMV+1SBLE+5GDG+HWI5T" alt="" />
    </div>;
  }
};
