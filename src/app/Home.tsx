...
export const Home = () => {
  ...
  return (
    <div>
      <div className="gap-5 grid sm:grid-cols-3 grid-cols-2 grid-rows-2 justify-center mb-5">
        <a href={"/about"}>
        ...
        <a href={"/products"}>
          <Card className="py-4 w-full h-full" isPressable>
            ...
            <CardBody className="overflow-visible py-2 flex justify-center items-center">
              <Image alt="Card background" className="object-cover rounded-xl" src="product.png" width={100} />
            </CardBody>
          </Card>
        </a>
        <a href={"/contact"}>
          <Card className="py-4 w-full h-full" isPressable>
            ...
            <CardBody className="overflow-visible py-2 flex justify-center items-center">
              <Image alt="Card background" className="object-cover rounded-xl" src="contact.png" width={100} />
            </CardBody>
          </Card>
        </a>
      </div>
